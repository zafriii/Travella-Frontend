...
//       }
//       fetchBlogs(); // Assuming fetchBlogs fetches the updated list of blogs
//     } catch (error) {
//       console.error('Error updating blog:', error);
//     }
//   };
...
//   const fetchBlogs = async () => {
//     try {
//       const response = await axios.get('https://travella-travel-planner-24.onrender.com/api/blogs');
//       setBlogs(response.data);
//     } catch (error) {
//       console.error('Error fetching blogs:', error);
//     }
...
//     if (editMode && editId !== null) {
//       try {
//         await axios.put(`https://travella-travel-planner-24.onrender.com/api/blogs/${editId}`, {
//           heading: blogHeading,
//           content: blogText,
//           name,
//         });
...
//       if (blogText.trim() !== '' && blogHeading.trim() !== '') {
//         try {
//           const response = await axios.post('https://travella-travel-planner-24.onrender.com/api/blogs', {
//             heading: blogHeading,
//             content: blogText,
//             name,
//           });
...
//     try {
//       await axios.delete(`https://travella-travel-planner-24.onrender.com/api/blogs/${deleteId}`);
...
//   const handleBlogUpdate = async (id, updatedData) => {
//     try {
//       const response = await axios.put(`https://travella-travel-planner-24.onrender.com/api/blogs/${id}`, updatedData);
//       if (!response.ok) {
//         throw new Error('Failed to update blog');
//       }
//       fetchBlogs();
...
//               <div>
//                 <button className='edit' onClick={() => editBlog(blog._id, blog.heading, blog.content, blog.name)}>Edit</button>
//                 <button onClick={() => requestDeleteBlog(blog._id)}>Delete</button>
//               </div>
//             )}
//             <div className="social-share2">
//               <FacebookShareButton url={window.location.href} quote={`Check out this blog: ${blog.heading}`}>
